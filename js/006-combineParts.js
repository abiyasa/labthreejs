...
$(function () {
    ...
    function initModels() {
        ...
        // init model data
        modelData.push({ 'modelFile': 'assets/milkcartonboy/milch_part_000.js', 'materialFile': 'assets/milkcartonboy/tex_body.png', 'posX': 0, 'posY': 0 });
        modelData.push({ 'modelFile': 'assets/milkcartonboy/milch_part_001.js', 'materialFile': 'assets/milkcartonboy/tex_hand.png', 'posX': 0, 'posY': 0 });
        modelData.push({ 'modelFile': 'assets/milkcartonboy/milch_part_002.js', 'materialFile': 'assets/milkcartonboy/tex_leg.png', 'posX': 0, 'posY': 0 });

        // prepare model container
        modelContainer = new THREE.Object3D();
        scene.add(modelContainer);
        modelContainer.position.y = -200;
